...
public:
     ...
     *
     * @param pin: GPIO pin number on the ESP32 board to which the DHT11 sensor is connected.
     */
...
private:
    gpio_num_t _pin;              // Pin number used for communication with the DHT11 sensor.
    uint32_t _delayMS = 500;      // Default delay in milliseconds between sensor readings.
